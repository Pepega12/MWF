...
var bot = {
  ...
  cmdprefix: "!",
  commands: null,
  discord: "https://discord.gg/DCZ6R5U",
  facebook: null,
  rules: null,
  web: null,
  language: "English",
  messages: {
    ...
    "English": {
      "onstart": "Bot version %BOTVERSION% created by Hellbyte is successfully enabled.",
      "botkilled": "Bot is successfully disabled.",
      "creator": "@%NAME% Creator of this bot is Hellbyte. If any problem you can contact him on Discord: @Hellbyte1337.",
      ...
      "maxlengthskipped": "@%NAME% your song is longer than 8 minutes. Im skipping.",
      ...
      "welcome": "Welcome @%NAME% to the community Exclusive Music. We are glad you came among us :heartpulse: and you came to listen only to EDM.",
    ...
    "Czech": {
      "onstart": "Bot verze %BOTVERSION% kterou vytvořil Hellbyte je úspěšně zapnutá.",
      "botkilled": "Bot je úspěšně vypnutý.",
      "creator": "@%NAME% Tvorca tohoto bota je Hellbyte. Pokud máte nějaký problém, můžete ho kontaktovat na Discordu: @Hellbyte1337.",

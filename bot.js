...
var bot = {
  ...
  messages: {
    ...
    "English": {
      ...
      "welcome": "Welcome @%NAME% to the community Music with friends! Please respect the rules and play the right songs! Have fun!",
    ...
    "Czech": {
      ...
      "welcome": "Vítej @%NAME% v komunitě Music with friends. Jsme rádi, že jste přišli mezi nás :heartpulse:.",
